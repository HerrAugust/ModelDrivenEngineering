...
public class WebApplicationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WebApplicationPackage.NAMED: {
				Named named = (Named)theEObject;
				T result = caseNamed(named);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebApplicationPackage.WEB_APPLICATION_MODEL: {
				WebApplicationModel webApplicationModel = (WebApplicationModel)theEObject;
				T result = caseWebApplicationModel(webApplicationModel);
				if (result == null) result = caseNamed(webApplicationModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseWebApplicationModel(WebApplicationModel object) {
		return null;
	}
