...
public class WebApplicationAdapterFactory extends AdapterFactoryImpl {
	...
	protected WebApplicationSwitch<Adapter> modelSwitch =
		new WebApplicationSwitch<Adapter>() {
			...
			@Override
			public Adapter caseWebApplicationModel(WebApplicationModel object) {
				return createWebApplicationModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link webApplication.WebApplicationModel <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createWebApplicationModelAdapter() {
		return null;
	}
