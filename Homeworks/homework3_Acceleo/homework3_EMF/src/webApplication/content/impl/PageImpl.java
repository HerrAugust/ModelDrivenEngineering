 ...
 * </p>
 * <ul>
 *   <li>{@link webApplication.content.impl.PageImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link webApplication.content.impl.PageImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link webApplication.content.impl.PageImpl#getForms <em>Forms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PageImpl extends NamedImpl implements Page {
	...
	protected EClass eStaticClass() {
		return ContentPackage.Literals.PAGE;
	}
	...
	public EList<Content> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<Content>(Content.class, this, ContentPackage.PAGE__CONTENTS);
		}
		return contents;
	}
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<Link>(Link.class, this, ContentPackage.PAGE__LINKS);
		}
		return links;
	}
	...
	public EList<Form> getForms() {
		if (forms == null) {
			forms = new EObjectContainmentEList<Form>(Form.class, this, ContentPackage.PAGE__FORMS);
		}
		return forms;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ContentPackage.PAGE__CONTENTS:
				return ((InternalEList<?>)getContents()).basicRemove(otherEnd, msgs);
			case ContentPackage.PAGE__LINKS:
				return ((InternalEList<?>)getLinks()).basicRemove(otherEnd, msgs);
			case ContentPackage.PAGE__FORMS:
